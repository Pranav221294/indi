...
{                                                         /* ---------------------------------------------- */
    ...
    __near  fdl_u8*        data_pu8;                    /* 2, W, pointer to the 1'st byte of data buffer  */
...
{                                                         /* ---------------------------------------------- */
            ...
            fdl_u8         eel_pool_blocks_u8;          /* 1, EEL-pool, size expressed in blocks          */
            fdl_u8         fdl_pool_blocks_u8;          /* 1, FDL-pool, size expressed in blocks          */
            fdl_u8         fx_MHz_u8;                   /* 1, system frequency expressed in MHz           */
            fdl_u8         wide_voltage_mode_u8;        /* 1, programming voltage mode ( full/wide )      */
} fdl_descriptor_t;                                       /*------------------------------------------------*/
                                                          /* 10 bytes in total                              */
...
R_FDLT02_STATIC_ASSERT(sizeof(fdl_u8)==1);
